/*
All of this source is fom django. (http://www.djangoproject.com)
/admin/jsi18n/
/admin/core.js
/admin/SelectBox.js
/admin/SelectFilter2.js
...
$('.selectfilter').each(function(){
    ...
    SelectFilter.init($select.attr('id'), $select.data('verbose-name'), $select.data('is-stacked'), $select.data('static'));
});
